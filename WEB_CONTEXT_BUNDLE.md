...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-569-erd-s-problem-569-e6dc91b6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-569"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-569-erd-s-problem-569-e6dc91b6-v1",
      "problem_contract_sha256": "2d49da9f13508acc562930edc92e1fb99c369b34628e3be07c4863c251437928",
      "problem_id": "problem:um-ep-569-erd-s-problem-569-e6dc91b6",
      "route_id": "route:um-ep-569-erd-s-problem-569-e6dc91b6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-569-erd-s-problem-569-e6dc91b6-source-fidelity-01",
      "graph_id": "graph:um-ep-569-erd-s-problem-569-e6dc91b6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-569-erd-s-problem-569-e6dc91b6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-569-erd-s-problem-569-e6dc91b6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k\\geq 1$. What is the best possible $c_k$ such that $ R(C_{2k+1},H)\\leq c_k m $ for any graph $H$ on $m$ edges without isolated vertices?"
          },
          "statement_sha256": "9e8b86b7635bfa53f647c4d28560e6be3a6dfe2513af880882b5cacea810a8ee"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-569-erd-s-problem-569-e6dc91b6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-569-erd-s-problem-569-e6dc91b6-root",
      "route_id": "route:um-ep-569-erd-s-problem-569-e6dc91b6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-569-5807cb931329",
        "url": "https://www.unsolvedmath.com/problems/EP-569"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
